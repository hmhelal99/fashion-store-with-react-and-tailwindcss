    ...
    return(
        <Fragment>
            <div className="flex items-center gap-4">
                <span className="py-4 px-7 bg-white-color font-medium text-4xl text-gray-800 rounded-md">{days} 
                ...
                <span className="py-4 px-7 bg-white-color font-medium text-4xl text-gray-800 rounded-md">{hours} 
                    <span className="block text-lg text-gray-text font-normal leading-none">Hrs</span> 
                </span>
                <span className="font-semibold text-6xl leading-none">:</span>
                <span className="py-4 px-7 bg-white-color font-medium text-4xl text-gray-800 rounded-md">{minutes} 
                    <span className="block text-lg text-gray-text font-normal leading-none">Mins</span> 
                </span>
                <span className="font-semibold text-6xl leading-none">:</span>
                <span className="py-4 px-7 bg-white-color font-medium text-4xl text-gray-800 rounded-md">{seconds} 
